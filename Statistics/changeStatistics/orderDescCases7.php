<?php 
    ...
    $cases7Descending = 'select `State/Territory`, `Total Cases`, `Cases in Last 7 Days`, `Total Deaths`, `Deaths in Last 7 Days` from united_states_covid19_cases_and_deaths_by_state__1_ order by `Cases in Last 7 Days` desc';
    $statement5 = $db->prepare($cases7Descending);
    $statement5 -> execute();
    $cases7DescendingSorted = $statement5 -> fetchAll();
...
<body>
    ...
    <main id="statistics">
        <table id="statisticsTable">
            ...
            <?php foreach($cases7DescendingSorted as $result): ?>
            <tr>
            ...
            casesBtn.addEventListener("click", () => {
                window.location = "./orderDescCases.php";
            });
            cases7DaysBtn.addEventListener("click", () => {
                window.location = "./orderAscCases7.php"
            });
