<?php 
    ...
    $casesAscending = 'select `State/Territory`, `Total Cases`, `Cases in Last 7 Days`, `Total Deaths`, `Deaths in Last 7 Days` from united_states_covid19_cases_and_deaths_by_state__1_ order by `Total Cases` asc';
    $statement5 = $db->prepare($casesAscending);
    $statement5 -> execute();
    $casesAscendingSorted = $statement5 -> fetchAll();
...
<body>
    ...
    <main id="statistics">
        <table id="statisticsTable">
            ...
            <tr>
            <?php foreach($casesAscendingSorted as $result): ?>
            <tr>
