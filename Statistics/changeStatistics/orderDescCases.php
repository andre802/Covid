<?php 
    ...
    $casesDescending = 'select `State/Territory`, `Total Cases`, `Cases in Last 7 Days`, `Total Deaths`, `Deaths in Last 7 Days` from united_states_covid19_cases_and_deaths_by_state__1_ order by `Total Cases` desc';
    $statement5 = $db->prepare($casesDescending);
    $statement5 -> execute();
    $casesDescendingSorted = $statement5 -> fetchAll();
...
<body>
    ...
    <main id="statistics">
        <table id="statisticsTable">
            ...
            <tr>
            <?php foreach($casesDescendingSorted as $result): ?>
            <tr>
