<?php 
    ...
    $deathsAscending = 'select `State/Territory`, `Total Cases`, `Cases in Last 7 Days`, `Total Deaths`, `Deaths in Last 7 Days` from united_states_covid19_cases_and_deaths_by_state__1_ order by `Total Deaths`';
    $statement5 = $db->prepare($deathsAscending);
    $statement5 -> execute();
    $deathsAscendingSorted = $statement5 -> fetchAll();
...
<body>
    ...
    <main id="statistics">
        <table id="statisticsTable">
            ...
            <tr>
            <?php foreach($deathsAscendingSorted as $result): ?>
            <tr>
